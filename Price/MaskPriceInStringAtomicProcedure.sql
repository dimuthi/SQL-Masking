CREATE PROCEDURE MaskPriceInStringAtomicProcedure @upperBound FLOAT,@lowerBound FLOAT,@decimalPecision INT,@priceStringNonEU varchar(max) OUTPUT
AS
BEGIN	
	DECLARE @cnt INT =1;
	...
	BEGIN
		...
		SET @priceStringNonEU = @finalPrice
	END 
	ELSE
	BEGIN		
